...
/** Page class to hold all information and references of a single .html page in the website
 * @author austi
 *
 */
public class Page {
	 ...
	 */
	long fileSize;
	/** local path within website
	 * 
	 */
	String path;
    /** Page constructor to be used in analysis, passing in relevant info for initial construction
     * @param name string title of webpage
     * @param id integer id number generated by analysis
     * @param fileSize size of file in kb according to html parser
	...
	/** intrasite link counter
	 * 
	 */
	int intraLinks = 0;
	/** external site link counter
	 * 
	 */
	int externalLinks = 0;
	/** inter-site link counter
	 * 
	 */
	int intersiteLinks = 0;

	/**HTML Extractor extracts anchor tags/links and classifies links as intra-page, intra-site, or external - Extracts Image tags and classifies as internal/external images - Extracts file size for each image, the URI for each image, and local pages on which it is referenced
	 * @param htmlfile title of file passed in
	 */
